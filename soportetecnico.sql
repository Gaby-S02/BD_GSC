...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2025 a las 05:03:03
...
(1, 'Roberto Jiménez', 'Hardware', 'roberto.jime', '610123456', 1),
(2, 'Sara Morales', 'Software', 'sara.morales', '610234567', 1),
(3, 'Pablo Ortega', 'Redes', 'pablo.ortega', '610345678', 1),
(4, 'Carmen Vega', 'Base de Datos', 'carmen.vega@', '610456789', 1),
(5, 'Alejandro Ruiz', 'Seguridad', 'alejandro.ru', '610567890', 1);
...
(1, 1, 1, 1, 'Problema de rendimiento', 'La laptop se encuentra muy lenta al ejecutar aplicaciones', 'Media', 'En Progreso', '2025-10-15 20:48:17', NULL),
(2, 2, 2, 2, 'Error de software', 'No inicia el sistema operativo, muestra pantalla azul', 'Alta', 'Abierto', '2025-10-15 20:48:17', NULL),
(3, 3, 3, 3, 'Problema de conexión', 'No se conecta a la red corporativa', 'Media', 'Cerrado', '2025-10-15 20:48:17', NULL);
...
(1, 1, 1, 'Diagnóstico inicial: posible falta de memoria RAM', '2025-10-15 20:48:17', 0.50),
(2, 1, 1, 'Instalada memoria RAM adicional - 8GB DDR4', '2025-10-15 20:48:17', 1.00),
(3, 3, 3, 'Configurada conexión de red y actualizados drivers', '2025-10-15 20:48:17', 1.50);
